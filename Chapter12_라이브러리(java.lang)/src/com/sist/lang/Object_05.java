 ...
 * 
 * 	java.lang
 * 		=> 자바 소스 기본이 되는 클래스 집합 = import 를 생략할 수 있다.
 * 		=> 컴파일러가 자동 추가
 * 		 	1. import java.lang.*
 * 			2. extends Object
 * 			3. 메소드 => void => return
 ...
 * 		   ------------ 데이터베이스 연동
 * 			Object o=new Object()
 * 			o=1, o=10.5 o=true ... 데이터 통합이 가능하다
 * 		   ------------------------
...
class Human
{
	...
	}//문자열 String 은 Object의 equals=>재정의
	//값만 비교 =>재정의(오버라이딩)
	//=>재정의해서 사용
...
public class Object_05 /*extends Object*/{
