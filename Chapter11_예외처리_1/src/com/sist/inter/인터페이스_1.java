 ...
 *   	}
 *   
 *   오버라이딩=> 모든 메소드는 public
 *   		   -----------다른 클래스와 연결 =>public
 *   클래스-------- 다른 클래스와 연결 =>public 기본으로 
 *   메소드-------- 다른 클래스와 연결 =>public 기본으로 
 *   변수: private: getter setter
 *   			   ------------- 메소드 : public
 *   생성자-------- 다른 클래스와 연결 =>public 기본으로 
 *   
...
{
	String COLOR="black";
	//public static final 생략임 인터페이스니까
	public void draw();
	//abstract 생략
}
